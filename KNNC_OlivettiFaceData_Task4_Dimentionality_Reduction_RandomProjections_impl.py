...
# 
# In this task you are supposed to reduce the dimensionality using l random
# projections with the values of l = 500; 1000; 1500; 2000; 2500.Use KNNC with values of
...
# consider fractional norms with r = 0:8; 0:5; 0:3. Compute the percentage accuracy
# using Leave-one-out-strategy and report results
...
#Transform data with random_projection
n_components_list = [500, 1000, 1500, 2000, 2500]
n_length = len(n_components_list)
for iter in range(n_length):
    transformer = random_projection.SparseRandomProjection(n_components = n_components_list[iter])
    transformer.fit(X_final)
    X_transformed = transformer.transform(X_final)
    ...
    for j in range(r_length):
        ...
        for i in range(length):
            ...
            pred_i_test = knn1.predict(X_test_trans)
            pred_i_train = knn1.predict(X_train_trans)
            accuracy = accuracy_score(y_test,pred_i_test)
            print('For Random Projection n_component',n_components_list[iter],'For r =',r_list[j],'K =',n_list[i])
        ...
        if(r_list[j] == 1): 
            if(n_components_list[iter] == 500): 
                fig.savefig("D:\IISC_Course\Assignment_2\RP500_K_value_vs_loo_accuracy_r1_Comparison.png")
            if(n_components_list[iter] == 1000): 
                fig.savefig("D:\IISC_Course\Assignment_2\RP1000_K_value_vs_loo_accuracy_r1_Comparison.png")
            if(n_components_list[iter] == 1500): 
                fig.savefig("D:\IISC_Course\Assignment_2\RP1500_K_value_vs_loo_accuracy_r1_Comparison.png")
            if(n_components_list[iter] == 2000): 
                fig.savefig("D:\IISC_Course\Assignment_2\RP2000_K_value_vs_loo_accuracy_r1_Comparison.png")
            if(n_components_list[iter] == 2500): 
                fig.savefig("D:\IISC_Course\Assignment_2\RP2500_K_value_vs_loo_accuracy_r1_Comparison.png")

        else:
            if(r_list[j] == 2):  
                if(n_components_list[iter] == 500): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP500_K_value_vs_loo_accuracy_r2_Comparison.png")
                if(n_components_list[iter] == 1000): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP1000_K_value_vs_loo_accuracy_r2_Comparison.png")
                if(n_components_list[iter] == 1500): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP1500_K_value_vs_loo_accuracy_r2_Comparison.png")
                if(n_components_list[iter] == 2000): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP2000_K_value_vs_loo_accuracy_r2_Comparison.png")
                if(n_components_list[iter] == 2500): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP2500_K_value_vs_loo_accuracy_r2_Comparison.png")
            else:
                if(n_components_list[iter] == 500): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP500_K_value_vs_loo_accuracy_rInf_Comparison.png")
                if(n_components_list[iter] == 1000): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP1000_K_value_vs_loo_accuracy_rInf_Comparison.png")
                if(n_components_list[iter] == 1500): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP1500_K_value_vs_loo_accuracy_rInf_Comparison.png")
                if(n_components_list[iter] == 2000): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP2000_K_value_vs_loo_accuracy_rInf_Comparison.png")
                if(n_components_list[iter] == 2500): 
                    fig.savefig("D:\IISC_Course\Assignment_2\RP2500_K_value_vs_loo_accuracy_rInf_Comparison.png")