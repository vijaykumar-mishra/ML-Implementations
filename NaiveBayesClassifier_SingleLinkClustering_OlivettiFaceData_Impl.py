...
for k in range(k_len):
    ...
    for n in range(10):
        ...
        for row in range(320):
            ...
            cluster = AgglomerativeClustering(n_clusters=k_list[k], affinity='euclidean', linkage='single')
        ...
        for row in range(80):
            ...
            cluster_test = AgglomerativeClustering(n_clusters=k_list[k], affinity='euclidean', linkage='single')
