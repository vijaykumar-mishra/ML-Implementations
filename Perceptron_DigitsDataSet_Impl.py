...
# Do this splitting randomly 10 times and report the average accuracy with Perceptron Classifier.
...
for p in range(length):
    ...
    for q in range(10):
        ...
        #create the perceptron classifier and train it
    ...
    print("Average Accuracy for Perceptron Classifier for test_size=",test_size_arr[p], " : ", total_accuracy/10)
